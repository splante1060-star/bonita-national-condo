  ...
  return (
    <>
      ...
      <Section className="amenities-note">
        <Container>
          <p>
            Guests may enjoy access to Bonita National’s community amenities
            with the required social membership transfer fee, subject to
            community rules and seasonal availability.
          </p>
        </Container>
      </Section>
      ...
      >
        ...
        <p>
          The fitness center at Bonita National gives you everything you need to
          keep your routine while still feeling like you are on vacation.
        </p>
        ...
        <p>
          ...
          during your stay. Guests also enjoy access to daily group fitness
          classes, offering a fun and motivating way to maintain routines or try
          something new.
        </p>
      </SplitSection>
      ...
      >
        ...
        <p>
          Bonita National also offers an on-site spa, including a nail salon,
          ideal for unwinding after a workout, round of golf, or day by the
          pool.
        </p>
      ...
      >
        ...
        <p>
          ...
          competitive league play. Whether you're an experienced player or
          simply looking to enjoy an active afternoon, the courts are just steps
          from the clubhouse.
        </p>

        <p>
          The community is also expanding its outdoor recreation with dedicated
          pickleball and bocce courts coming soon, giving guests even more ways
          to enjoy Florida's beautiful weather and resort lifestyle.
        </p>
      </SplitSection>
      ...
      >
        ...
        <p>
          Dining at Bonita National offers a variety of on-site options, from
          refined meals in the Clubhouse to relaxed, casual fare at the Poolside
          Café.
        </p>

        <p>
          Whether you're enjoying an evening out or grabbing a quick bite after
          golf, tennis, or a day by the pool, the community's dining venues wrap
          convenience and quality into an easy, enjoyable experience, all
          without ever leaving Bonita National.
        </p>
      </SplitSection>
      ...
      <Section className="amenity-map-section">
        <Container>
          <div className="amenity-map-section__content">
            ...
            <p>
              From the resort pool and clubhouse to tennis, fitness, spa,
              dining, and satellite pools, the amenity map gives guests an easy
              overview of the community layout before they arrive.
            </p>
          </div>
