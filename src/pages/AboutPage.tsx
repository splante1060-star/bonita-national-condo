  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Bonita National is centered around a scenic championship golf course
          with lush fairways, peaceful preserves, and beautiful views throughout
          the neighborhood.
        </p>
        <p>
          Whether you are playing a round or simply enjoying the view from the
          lanai, the golf course is part of what makes the community feel so
          open, relaxed, and distinctly Southwest Florida.
        </p>
      </SplitSection>
      ...
      >
        ...
        <p>
          From the resort pool and clubhouse to dining, fitness, tennis, spa
          services, and social spaces, Bonita National offers the kind of
          lifestyle that makes every day feel like vacation.
        </p>
        <p>
          It is a community designed for slow mornings, sunny afternoons, and
          evenings spent enjoying everything Southwest Florida has to offer.
        </p>
      </SplitSection>
      ...
      >
        ...
        <p>
          Bonita National offers the perfect home base for experiencing
          Southwest Florida. Spend your mornings at Bonita Beach, enjoy an
          afternoon of shopping at Coconut Point, dine along Fifth Avenue South
          in Naples, or simply watch another unforgettable Gulf Coast sunset. No
          matter how you choose to spend your day, everything is just a short
          drive away.
        </p>
